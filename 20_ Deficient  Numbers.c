/*
15) write a program to findout whether given number is Deficient  Numbers or not
...
void main()
{
    ...
    if(sum <= number)
    {
        printf("this is Deficient  number");
    }
    else 
    {
        printf(" sorry this is not Deficient number");
    }
}